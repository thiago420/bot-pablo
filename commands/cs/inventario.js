    ...
    async execute(interaction, userData) {
        ...
        collector2.on("collect", async (i) => {
            ...
            const buttonLink = new ButtonBuilder()
                .setURL(`https://thiago420.github.io/botPabloWeb/inspectRedirector/inspect.html?url=${link.match(/steam:\/\/rungame\/730\/76561202255233023\/\+csgo_econ_action_preview%20([A-Za-z0-9]+)/)[1]}`)
